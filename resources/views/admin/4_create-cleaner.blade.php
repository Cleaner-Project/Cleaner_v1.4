                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        ...
                                        <div class="user-avatar xl-avatar">
                                            <img class="rounded" src="{{asset('asset-admin/assets/img/team/profile-picture-3.jpg')}}" alt="change avatar">
                                        </div>
                                    </div>
                            ...
                            <div class="card card-body shadow-sm mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        <!-- Avatar -->
                                        <div class="user-avatar xl-avatar">
                                            <img class="rounded" src="{{asset('asset-admin/assets/img/profile-cover.jpg')}}" alt="change cover photo">
                                        </div>
                                    </div>
                                    <div class="file-field">
                                        <div class="d-flex justify-content-xl-center ms-xl-3">
